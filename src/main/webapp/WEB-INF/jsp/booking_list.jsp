					...
					<div class="col-lg-8 p-r-0 title-margin-right">
						<div class="page-header">
							<div class="page-title">
									...
									<br />
									<form method="GET">
										Dzień rezerwacji: <input type="date" name="selectedDate" value="${param.selectedDate}">
                                    ...
                                    <table id="responstable">
										...
										<td> <input class="btn btn-primary btn-block" type="submit" value="Edytuj" onclick="location.href='booking/${booking.id}'"></td>
									</tr>	
									</c:forEach> 
