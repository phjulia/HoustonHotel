...
<jsp:include page="navigation.jsp"/>
						...
						<div class="page-header">
							<div class="page-title">
                                    ...
                                    <table id="responstable">
                                		...
                                		<tr>
                                		<td>${ordering.orderingId} </td> 
                                		<td>${ordering.firstName} </td> 
                                		<td>${ordering.lastName} </td>
                                		<td>${ordering.roomNum} </td> 
                                		<td>${ordering.name} </td> 
                                		
										<td> <input class="btn btn-primary btn-block" type="submit" value="Edytuj" onclick="location.href='ordering/${ordering.orderingId}'"></td>
									</tr>	
									</c:forEach> 
    ...
    <script src="webapp/static_files/js/lib/bootstrap.min.js"></script><script src="webapp/static_files/js/scripts.js"></script>
    <!-- scripit init-->
