...
<title>Przypisanie produktu do zamówienia</title>
                     ...
                     <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-title">
                                    <h4>Przypisanie produktu do zamówienia nr ${ordering.orderingId }</h4>
                    
                                    <div id="orderings">
                                    <form:form method="post" action="edit" modelAttribute="ordering">
                                    <table>
                                       <form:hidden path="orderingId" />
 										 <tr>
                                		...
                                		<td>
														...
														<form:select path="name" items="${ordering.names}">
