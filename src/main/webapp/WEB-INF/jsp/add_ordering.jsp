				...
				<div class="row">
					<div class="col-lg-8 p-r-0 title-margin-right">
						<div class="page-header">
							...
							<h4>Formularz dodania zamówienia</h4></div>
						</div>
					</div>
				</div>
				<!-- /# row -->
					...
					<!-- <div class="card"> -->
						<div class="card-body">
							<div class="outer_div">
								...
								<form:form class="form" action="add_ordering" modelAttribute="ordering" method="POST" onsubmit="return validateOrderForm();" novalidate="novalidate">
								
									
									<div class="form-group col">
										<label for="name">Numer rezerwacji</label> 
										<form:select class="form-control" path="reservationId" items="${bookingsList}" itemLabel="Id" itemValue="Id">
									...
									<div class="form-group col">
										<label for="name">Zamawiany produkt</label> 
										<form:select class="form-control" path="orderItemId" items="${itemsList}" itemLabel="name" itemValue="itemId">
											<form:option value="NONE">--Wybierz--</form:option>
											<form:options></form:options>
										</form:select>
									</div>
