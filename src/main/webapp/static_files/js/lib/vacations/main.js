...
function selectDates() {
		/* * * * *  here enter dates*****/
	var json = document.getElementById("vacation").value;
	...
	var f,s;
	f=new Date(2022,06,09);
	var fYear=f.getYear()+1900;
	var fMonth=f.getMonth();
	var fDate=f.getDate();
	s=new Date(2022,06,27);
	selected = {};
	selected[f.getYear()] = {};
	selected[fYear][fMonth] = [fDate];
	selected = addChosenDates(f, s, selected);
	console.log("*********");
	console.log(f.getYear()+1900);
